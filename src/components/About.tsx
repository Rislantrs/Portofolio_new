              ...
              <div className="flex flex-wrap items-center justify-start gap-3 sm:gap-4 pt-2">
                ...
                <div className="flex min-w-0 flex-wrap items-center gap-2.5">
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    title="LinkedIn"
                    className="w-9 h-9 flex items-center justify-center rounded-xl border border-neutral-200 hover:border-black text-neutral-500 hover:text-black hover:bg-neutral-50 hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-accent transition-all duration-300 cursor-pointer"
                  >
            ...
            <div className="grid w-full max-w-[860px] gap-3 md:gap-4">
              {education.map((item) => (
                <div key={item.title} className="flex items-center gap-4 border-l border-black/15 bg-white/25 py-3 pl-4 pr-4">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center relative">
                    <Image src={item.logo} alt={`${item.title} logo`} fill sizes="44px" className="object-contain" />
                  </div>
            ...
            <div className="grid w-full max-w-[860px] gap-3 md:gap-4">
              {experiences.map((exp, idx) => (
                <div key={idx} className="flex items-start gap-4 border-l border-black/15 bg-white/25 py-3.5 pl-4 pr-4">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center mt-1 bg-white/50 rounded-lg p-1 border border-black/5 relative">
                    <Image src={exp.logo} alt={`${exp.title} logo`} fill sizes="36px" className="object-contain p-1" />
                  </div>
